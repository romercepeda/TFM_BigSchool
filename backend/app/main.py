...
from app.api.dividends import payments_router as dividend_payments_router
from app.api.dividends import schedule_router as dividend_schedule_router
...
app.include_router(dividend_schedule_router)
