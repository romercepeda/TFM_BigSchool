...
### 2.5 Archivos de tokens/tema (copiados tal cual)

`frontend/src/styles/tokens.css`, `frontend/src/styles/themes/dark.css`, `frontend/src/styles/themes/pastel.css`, `frontend/src/styles/themes/ocean.css` y `frontend/src/styles/themes/forest.css` están adjuntos íntegros en [`./tokens/`](./tokens/) junto a este informe (copia literal, sin editar).
...
**Capturas** (cartera real "Cartera Personal": INTC, TEF, SNDK, IDR, IAG):

| Claro (pastel) | Oscuro |
|---|---|
| ![Dashboard claro](./screenshots/dashboard_pastel.png) | ![Dashboard oscuro](./screenshots/dashboard_dark.png) |
...
**Capturas** (activo real: Intel / INTC, 50 unidades a 19,50 USD):

| Claro (pastel) | Oscuro |
|---|---|
| ![Detalle activo claro](./screenshots/asset_detail_pastel.png) | ![Detalle activo oscuro](./screenshots/asset_detail_dark.png) |
...
| Claro (pastel) | Oscuro |
|---|---|
| ![Guía indicadores claro](./screenshots/indicators_legend_pastel.png) | ![Guía indicadores oscuro](./screenshots/indicators_legend_dark.png) |
...
| Claro (pastel) | Oscuro |
|---|---|
| ![Carteras claro](./screenshots/portfolios_pastel.png) | ![Carteras oscuro](./screenshots/portfolios_dark.png) |
...
**Capturas** (3 informes reales de Intel ya procesados por Gemini):

| Claro (pastel) | Oscuro |
|---|---|
| ![Análisis IA claro](./screenshots/analysis_pastel.png) | ![Análisis IA oscuro](./screenshots/analysis_dark.png) |
...
Captura directa de la app (ver §3.2), 50 unidades a 19,50 USD:
...
### 6.3 Ejemplo real de salida (los 3 informes de Intel visibles en la captura de §3.5)
...
Estos puntos no estaban en el guion pedido, pero salieron directamente de leer el código y de las capturas reales, y son relevantes para priorizar el rediseño:
...
## Anexo: archivos de tokens/tema

Ver carpeta [`./tokens/`](./tokens/) — copia literal de `tokens.css`, `dark.css`, `pastel.css`, `ocean.css`, `forest.css` y `app-config.ts`.
