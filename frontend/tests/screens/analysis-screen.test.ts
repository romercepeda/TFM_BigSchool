  ...
  mockReports: [
    {
      ...
      model_version: 'gemini-2.0', global_signal: 'bullish',
      executive_summary_es: 'Trimestre sólido.', executive_summary_en: 'Solid quarter.',
    ...
    },
    {
      ...
      model_version: 'gemini-2.0', global_signal: 'neutral',
      executive_summary_es: 'Resultados mixtos.', executive_summary_en: 'Mixed results.',
